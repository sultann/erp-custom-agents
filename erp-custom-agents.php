...
class ERP_Custom_Agents {
	...
	private function define_constants() {
		...
		define( 'ERPCA_HRM_MODULE', ERPCA_MODULES . '/hrm' );
		define( 'ERPCA_CRM_MODULE', ERPCA_MODULES . '/crm' );
		define( 'ERPCA_AC_MODULE', ERPCA_MODULES . '/accounting' );
	}
	...
	public function includes( ) {
		...
		require_once ERPCA_INCLUDES.'/functions.php';
		require_once ERPCA_INCLUDES.'/erpc-user.php';
		require_once ERPCA_INCLUDES.'/add-roles.php';
		require ERPCA_INCLUDES .'/class-user-update.php';

		if(erp_is_module_active('hrm')){
			require_once ERPCA_HRM_MODULE.'/hrm.php';
		}
		if(erp_is_module_active('crm')){
			require_once ERPCA_CRM_MODULE.'/crm.php';
		}
		if(erp_is_module_active('accounting')){
			require_once ERPCA_AC_MODULE.'/accounting.php';
		}
